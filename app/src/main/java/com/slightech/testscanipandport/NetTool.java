...
/**
 * Created by Rokey on 2016/11/16.
 */
...
//            os.flush();// 刷新输出流，使Server马上收到该字符串
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (result == 0) {
                            Log.i("rokey","连接成功" + current_ip);
                            // 向服务器发送验证信息
                            connect(current_ip,SERVERPORT);
                        } else {
    ...
    private void connect(String server ,int port){
        final AsyncHttpGet get = new AsyncHttpGet("http://" + server + ":" + port + "/control");
            ...
            public void onCompleted(Exception ex, WebSocket webSocket) {
                    ...
                    if (webSocket == null) {
                        ...
                        try {
                            ...
                            byteBuffer.putInt(7);
                            byteBuffer.put(bytes);
                           webSocket.send(byteBuffer.array());
                        } catch (UnsupportedEncodingException e) {
                            e.printStackTrace();
                        }
                    }
